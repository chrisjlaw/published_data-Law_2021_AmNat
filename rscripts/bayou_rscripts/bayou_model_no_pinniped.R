...
#run1
lnsize_fit1 <- bayou.makeMCMC(tree_prune, lnsize_all, SE=size_se_all, model="OU", prior=lnsize_prior, file.dir="Rdata/bayou/Mustela/bayou_size/", outname="lnsize_fit1", plot.freq=200000, ticker.freq=50000)
lnsize_fit1$run(1500000)
lnsize_chain1<-lnsize_fit1$load()
save(lnsize_chain1, file="bayou_lnsize_chain1.2_no_pinnipeds.Rdata")
lnsize_chain1 <- set.burnin(lnsize_chain1, 0.3)
plot(lnsize_chain1)
lnsize_out1 <- summary(lnsize_chain1)
write_no_pinnipeds.csv(lnsize_out1$branch.posteriors, file="lnsize_branch.posteriors_no_pinnipeds.csv")
write_no_pinnipeds.csv(lnsize_out1$statistics, file="lnsize_statistics_no_pinnipeds.csv")

#run2
lnsize_fit2 <- bayou.makeMCMC(tree_prune, lnsize_all, SE=size_se_all, model="OU", prior=lnsize_prior, file.dir="Rdata/bayou/Mustela/bayou_size/", outname="lnsize_fit2", plot.freq=200000, ticker.freq=50000)
lnsize_fit2$run(1500000)
lnsize_chain2<-lnsize_fit2$load()
save(lnsize_chain2, file="bayou_lnsize_chain2_no_pinnipeds.Rdata")
lnsize_chain2 <- set.burnin(lnsize_chain2, 0.3)
plot(lnsize_chain2)
lnsize_out2 <- summary(lnsize_chain2)
write_no_pinnipeds.csv(lnsize_out2$branch.posteriors, file="lnsize_branch.posteriors_no_pinnipeds.csv")
write_no_pinnipeds.csv(lnsize_out2$statistics, file="lnsize_statistics_no_pinnipeds.csv")

load("Rdata/bayou/Mustela/bayou_lnsize_chain1.2_no_pinnipeds.Rdata")
...
load("Rdata/bayou/Mustela/bayou_lnsize_chain2.2_no_pinnipeds.Rdata")
...
#run1
lnhbER_fit1 <- bayou.makeMCMC(tree_prune, lnhbER_all, SE=hbER_se_all, model="OU", prior=lnhbER_prior, file.dir="Rdata/bayou/Mustela/bayou_hbER_no_pinnipeds/", outname="lnhbER_fit1", plot.freq=200000, ticker.freq=50000)
lnhbER_fit1$run(1500000)
lnhbER_chain1<-lnhbER_fit1$load()
save(lnhbER_chain1, file="bayou_lnhbER_chain1.2_no_pinnipeds.Rdata")
lnhbER_chain1 <- set.burnin(lnhclaw8ER_chain1, 0.3)
lnhbER_out1 <- summary(lnhbER_chain1)
write.csv(lnhbER_out1$branch.posteriors, file="lnhbER_branch.posteriors_run1_no_pinnipeds.csv")
write.csv(lnhbER_out1$statistics, file="lnhbER_statistics_run1_no_pinnipeds.csv")

#run2
lnhbER_fit2 <- bayou.makeMCMC(tree_prune, lnhbER_all, SE=hbER_se_all, model="OU", prior=lnhbER_prior, file.dir="Rdata/bayou/Mustela/bayou_hbER_no_pinnipeds/", outname="lnhbER_fit2", plot.freq=200000, ticker.freq=50000)
lnhbER_fit2$run(1500000)
lnhbER_chain2<-lnhbER_fit2$load()
save(lnhbER_chain2, file="bayou_lnhbER_chain2_no_pinnipeds.Rdata")
lnhbER_chain2 <- set.burnin(lnhbER_chain2, 0.3)
lnhbER_out2 <- summary(lnhbER_chain2)
write.csv(lnhbER_out2$branch.posteriors, file="lnhbER_branch.posteriors_run2-no_pinnipeds.csv")
write.csv(lnhbER_out2$statistics, file="lnhbER_statistics_run2_no_pinnipeds.csv")

load("Rdata/bayou/Mustela/bayou_lnhbER_chain1.2_no_pinnipeds.Rdata")
pdf(width=5, height =7, file="bayou_hbER_shifts_no_pinnipeds.pdf")
...
load("Rdata/bayou/Mustela/bayou_lnhbER_chain2.2_no_pinnipeds.Rdata")
pdf(width=5, height =7, file="bayou_hbER_shifts_run2_no_pinnipeds.pdf")
...
#run1
lnheadER_fit1 <- bayou.makeMCMC(tree_prune, lnheadER_all, SE=headER_se_all, model="OU", prior=lnheadER_prior, file.dir="Rdata/bayou/Mustela/bayou_headER/", outname="lnheadER_fit1", plot.freq=200000, ticker.freq=50000)
lnheadER_fit1$run(1500000)
lnheadER_chain1<-lnheadER_fit1$load()
save(lnheadER_chain1, file="bayou_lnheadER_chain1_no_pinnipeds.Rdata")
lnheadER_chain1 <- set.burnin(lnheadER_chain1, 0.3)
plot(lnheadER_chain1)
lnheadER_out1 <- summary(lnheadER_chain1)
write_no_pinnipeds.csv(lnheadER_out1$branch.posteriors, file="lnheadER_branch.posteriors_no_pinnipeds.csv")
write_no_pinnipeds.csv(lnheadER_out1$statistics, file="lnheadER_statistics_no_pinnipeds.csv")
...
#run2
lnheadER_fit2 <- bayou.makeMCMC(tree_prune, lnheadER_all, SE=headER_se_all, model="OU", prior=lnheadER_prior, file.dir="Rdata/bayou/Mustela/bayou_headER/", outname="lnheadER_fit2", plot.freq=200000, ticker.freq=50000)
lnheadER_fit2$run(1500000)
lnheadER_chain2<-lnheadER_fit2$load()
save(lnheadER_chain2, file="bayou_lnheadER_chain2_no_pinnipeds.Rdata")
lnheadER_chain2 <- set.burnin(lnheadER_chain2, 0.3)
plot(lnheadER_chain2)
lnheadER_out2 <- summary(lnheadER_chain2)
write_no_pinnipeds.csv(lnheadER_out2$branch.posteriors, file="lnheadER_branch.posteriors_no_pinnipeds.csv")
write_no_pinnipeds.csv(lnheadER_out2$statistics, file="lnheadER_statistics_no_pinnipeds.csv")
...
#run3
lnheadER_fit3 <- bayou.makeMCMC(tree_prune, lnheadER_all, SE=headER_se_all, model="OU", prior=lnheadER_prior, file.dir="Rdata/bayou/Mustela/bayou_headER/", outname="lnheadER_fit3", plot.freq=200000, ticker.freq=50000)
lnheadER_fit3$run(3000000)
lnheadER_chain3<-lnheadER_fit3$load()
save(lnheadER_chain3, file="bayou_lnheadER_chain3.2_no_pinnipeds.Rdata")
...
#run1
lnAEI_C_fit1 <- bayou.makeMCMC(tree_prune, lnAEI_C_all, SE=AEI_C_se_all, model="OU", prior=lnAEI_C_prior, file.dir="Rdata/bayou/Mustela/bayou_AEI_C/", outname="lnAEI_C_fit1", plot.freq=200000, ticker.freq=50000)
lnAEI_C_fit1$run(1500000)
lnAEI_C_chain1<-lnAEI_C_fit1$load()
save(lnAEI_C_chain1, file="bayou_lnAEI_C_chain1_no_pinnipeds.Rdata")
lnAEI_C_chain1 <- set.burnin(lnAEI_C_chain1, 0.3)
plot(lnAEI_C_chain1)
lnAEI_C_out1 <- summary(lnAEI_C_chain1)
write_no_pinnipeds.csv(lnAEI_C_out1$branch.posteriors, file="lnAEI_C_branch.posteriors_no_pinnipeds.csv")
write_no_pinnipeds.csv(lnAEI_C_out1$statistics, file="lnAEI_C_statistics_no_pinnipeds.csv")
...
lnAEI_C_fit2 <- bayou.makeMCMC(tree_prune, lnAEI_C_all, SE=AEI_C_se_all, model="OU", 
                               prior=lnAEI_C_prior, file.dir="Rdata/bayou/Mustela/bayou_AEI_C2/", outname="lnAEI_C_fit2", plot.freq=200000, ticker.freq=50000)
lnAEI_C_fit2$run(1500000)
lnAEI_C_chain2<-lnAEI_C_fit2$load()
save(lnAEI_C_chain2, file="bayou_lnAEI_C_chain2_no_pinnipeds.Rdata")
lnAEI_C_chain2 <- set.burnin(lnAEI_C_chain2, 0.3)
plot(lnAEI_C_chain2)
lnAEI_C_out2 <- summary(lnAEI_C_chain2)
write_no_pinnipeds.csv(lnAEI_C_out2$branch.posteriors, file="lnAEI_C_branch.posteriors_no_pinnipeds.csv")
write_no_pinnipeds.csv(lnAEI_C_out2$statistics, file="lnAEI_C_statistics_no_pinnipeds.csv")
...
#run1
lnAEI_T_fit1 <- bayou.makeMCMC(tree_prune, lnAEI_T_all, SE=AEI_T_se_all, model="OU", prior=lnAEI_T_prior, file.dir="Rdata/bayou/Mustela/bayou_AEI_T/", outname="lnAEI_T_fit1", plot.freq=200000, ticker.freq=50000)
lnAEI_T_fit1$run(3000000)
lnAEI_T_chain1<-lnAEI_T_fit1$load()
save(lnAEI_T_chain1, file="bayou_lnAEI_T_chain1.2_no_pinnipeds.Rdata")
lnAEI_T_chain1 <- set.burnin(lnAEI_T_chain1, 0.3)
plot(lnAEI_T_chain1)
lnAEI_T_out1 <- summary(lnAEI_T_chain1)
write_no_pinnipeds.csv(lnAEI_T_out1$branch.posteriors, file="lnAEI_T_branch.posteriors_no_pinnipeds.csv")
write_no_pinnipeds.csv(lnAEI_T_out1$statistics, file="lnAEI_T_statistics_no_pinnipeds.csv")
...
#run2
lnAEI_T_fit2 <- bayou.makeMCMC(tree_prune, lnAEI_T_all, SE=AEI_T_se_all, model="OU", prior=lnAEI_T_prior, file.dir="Rdata/bayou/Mustela/bayou_AEI_T/", outname="lnAEI_T_fit2", plot.freq=200000, ticker.freq=50000)
lnAEI_T_fit2$run(3000000)
lnAEI_T_chain2<-lnAEI_T_fit2$load()
save(lnAEI_T_chain2, file="bayou_lnAEI_T_chain2.2_no_pinnipeds.Rdata")
lnAEI_T_chain2 <- set.burnin(lnAEI_T_chain2, 0.3)
plot(lnAEI_T_chain2)
lnAEI_T_out2 <- summary(lnAEI_T_chain2)
write_no_pinnipeds.csv(lnAEI_T_out2$branch.posteriors, file="lnAEI_T_branch.posteriors_no_pinnipeds.csv")
write_no_pinnipeds.csv(lnAEI_T_out2$statistics, file="lnAEI_T_statistics_no_pinnipeds.csv")
...
#run1
lnAEI_L_fit1 <- bayou.makeMCMC(tree_prune, lnAEI_L_all, SE=AEI_L_se_all, model="OU", prior=lnAEI_L_prior, file.dir="Rdata/bayou/Mustela/bayou_AEI_L/", outname="lnAEI_L_fit1", plot.freq=200000, ticker.freq=50000)
lnAEI_L_fit1$run(1500000)
lnAEI_L_chain1<-lnAEI_L_fit1$load()
save(lnAEI_L_chain1, file="bayou_lnAEI_L_chain1_no_pinnipeds.Rdata")
lnAEI_L_chain1 <- set.burnin(lnAEI_L_chain1, 0.3)
plot(lnAEI_L_chain1)
lnAEI_L_out1 <- summary(lnAEI_L_chain1)
write_no_pinnipeds.csv(lnAEI_L_out1$branch.posteriors, file="lnAEI_L_branch.posteriors_no_pinnipeds.csv")
write_no_pinnipeds.csv(lnAEI_L_out1$statistics, file="lnAEI_L_statistics_no_pinnipeds.csv")
...
#run2
lnAEI_L_fit2 <- bayou.makeMCMC(tree_prune, lnAEI_L_all, SE=AEI_L_se_all, model="OU", prior=lnAEI_L_prior, file.dir="Rdata/bayou/Mustela/bayou_AEI_L/", outname="lnAEI_L_fit2", plot.freq=200000, ticker.freq=50000)
lnAEI_L_fit2$run(1500000)
lnAEI_L_chain2<-lnAEI_L_fit2$load()
save(lnAEI_L_chain2, file="bayou_lnAEI_L_chain2_no_pinnipeds.Rdata")
lnAEI_L_chain2 <- set.burnin(lnAEI_L_chain2, 0.3)
plot(lnAEI_L_chain2)
lnAEI_L_out2 <- summary(lnAEI_L_chain2)
write_no_pinnipeds.csv(lnAEI_L_out2$branch.posteriors, file="lnAEI_L_branch.posteriors_no_pinnipeds.csv")
write_no_pinnipeds.csv(lnAEI_L_out2$statistics, file="lnAEI_L_statistics_no_pinnipeds.csv")
...
#run1
lnAEI_S_fit1 <- bayou.makeMCMC(tree_prune, lnAEI_S_all, SE=AEI_S_se_all, model="OU", prior=lnAEI_S_prior, file.dir="Rdata/bayou/Mustela/bayou_AEI_S/", outname="lnAEI_S_fit1", plot.freq=200000, ticker.freq=50000)
lnAEI_S_fit1$run(1500000)
lnAEI_S_chain1<-lnAEI_S_fit1$load()
save(lnAEI_S_chain1, file="bayou_lnAEI_S_chain1_no_pinnipeds.Rdata")
lnAEI_S_chain1 <- set.burnin(lnAEI_S_chain1, 0.3)
plot(lnAEI_S_chain1)
lnAEI_S_out1 <- summary(lnAEI_S_chain1)
write_no_pinnipeds.csv(lnAEI_S_out1$branch.posteriors, file="lnAEI_S_branch.posteriors_no_pinnipeds.csv")
write_no_pinnipeds.csv(lnAEI_S_out1$statistics, file="lnAEI_S_statistics_no_pinnipeds.csv")
...
#run2
lnAEI_S_fit2 <- bayou.makeMCMC(tree_prune, lnAEI_S_all, SE=AEI_S_se_all, model="OU", prior=lnAEI_S_prior, file.dir="Rdata/bayou/Mustela/bayou_AEI_S/", outname="lnAEI_S_fit2", plot.freq=200000, ticker.freq=50000)
lnAEI_S_fit2$run(1500000)
lnAEI_S_chain2<-lnAEI_S_fit2$load()
save(lnAEI_S_chain2, file="bayou_lnAEI_S_chain2_no_pinnipeds.Rdata")
lnAEI_S_chain2 <- set.burnin(lnAEI_S_chain2, 0.3)
plot(lnAEI_S_chain2)
lnAEI_S_out2 <- summary(lnAEI_S_chain2)
write_no_pinnipeds.csv(lnAEI_S_out2$branch.posteriors, file="lnAEI_S_branch.posteriors_no_pinnipeds.csv")
write_no_pinnipeds.csv(lnAEI_S_out2$statistics, file="lnAEI_S_statistics_no_pinnipeds.csv")
...
#run1
lnrib_sc_fit1 <- bayou.makeMCMC(tree_prune, lnrib_sc_all,  model="OU", prior=lnrib_sc_prior, file.dir="Rdata/bayou/Mustela/bayou_rib_sc/", outname="lnrib_sc_fit1", plot.freq=200000, ticker.freq=50000)
lnrib_sc_fit1$run(1500000)
lnrib_sc_chain1<-lnrib_sc_fit1$load()
save(lnrib_sc_chain1, file="bayou_lnrib_sc_chain1_no_pinnipeds.Rdata")
lnrib_sc_chain1 <- set.burnin(lnrib_sc_chain1, 0.3)
plot(lnrib_sc_chain1)
lnrib_sc_out1 <- summary(lnrib_sc_chain1)
write_no_pinnipeds.csv(lnrib_sc_out1$branch.posteriors, file="lnrib_sc_branch.posteriors_no_pinnipeds.csv")
write_no_pinnipeds.csv(lnrib_sc_out1$statistics, file="lnrib_sc_statistics_no_pinnipeds.csv")
...
#run2
lnrib_sc_fit2 <- bayou.makeMCMC(tree_prune, lnrib_sc_all,  model="OU", prior=lnrib_sc_prior, file.dir="Rdata/bayou/Mustela/bayou_rib_sc/", outname="lnrib_sc_fit2", plot.freq=200000, ticker.freq=50000)
lnrib_sc_fit2$run(1500000)
lnrib_sc_chain2<-lnrib_sc_fit2$load()
save(lnrib_sc_chain2, file="bayou_lnrib_sc_chain2_no_pinnipeds.Rdata")
lnrib_sc_chain2 <- set.burnin(lnrib_sc_chain2, 0.3)
plot(lnrib_sc_chain2)
lnrib_sc_out2 <- summary(lnrib_sc_chain2)
write_no_pinnipeds.csv(lnrib_sc_out2$branch.posteriors, file="lnrib_sc_branch.posteriors_no_pinnipeds.csv")
write_no_pinnipeds.csv(lnrib_sc_out2$statistics, file="lnrib_sc_statistics_no_pinnipeds.csv")
