...
lnrib_sc_all <- as.numeric(as.character(lnrib_sc_all))
...
save(simmap_diet_1000, file="simmap_diet_1000.Rdata")
simmap_diet_1000_sam500 <- sample(simmap_diet_1000[1:10000],500)
save(simmap_diet_1000_sam500, file="simmap_diet_1000_sam500.Rdata")
...
save(simmap_locomotion_1000, file="simmap_locomotion_1000.Rdata")
simmap_locomotion_1000_sam500 <- sample(simmap_locomotion_1000[1:10000],500)
save(simmap_locomotion_1000_sam500, file="simmap_locomotion_1000_sam500.Rdata")
...
save(simmap_hunting_1000, file="simmap_hunting_1000.Rdata")
simmap_hunting_1000_sam500 <- sample(simmap_hunting_1000[1:10000],500)
save(simmap_hunting_1000_sam500, file="simmap_hunting_1000_sam500.Rdata")
